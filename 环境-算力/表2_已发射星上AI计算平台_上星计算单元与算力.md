...
| ---------- | ----------------------------------------------- | ---------------------: | ------------------------ | ---------------------------------------------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------- |
| 欧洲         | Φsat-1 / FSSCat                                 |             2020-09-03 | 6U CubeSat 遥感技术验证        | HyperScout-2 载荷内集成 Intel Movidius Myriad 2 VPU                                     | 约 1 TOPS                                  | 512 MB LPDDR3                                                                          | 星上 CNN 云检测、图像筛选，减少无效影像下传                                              | [R1–R3]         |
| 欧洲         | Φsat-2                                          |             2024-08-16 | 6U CubeSat 遥感技术验证        | Ubotica CogniSAT-XE1 板级 AI 载荷处理器；Intel Movidius Myriad 2 VPU（12 个向量核）              | 未公开                                       | 板级：典型 2 W、最大 5 W（功耗为 CogniSAT-XE1 板级规格，非 Φsat-2 整星或任务实测）                               | 在轨运行可安装式 AI 应用：云检测、船舶检测与分类、图像压缩、图像到地图转换等                              | [R3, R4]        |
| 澳大利亚 / 意大利 | SpIRIT / Loris                                  |             2023-12-01 | 6U CubeSat 多相机 AI 载荷     | NVIDIA Jetson Nano 单板计算机；128-core Maxwell GPU + 四核 Cortex-A57 CPU                  | 472 GFLOPS（Jetson Nano 模组标称峰值；非在轨任务实测）    | 4 GB 64-bit LPDDR4（25.6 GB/s）；16 GB eMMC；5/10 W 可选功耗模式（均为模组规格）                         | 可见光/长波红外相机处理、载荷设计支持在轨微调/模型适应、JPEG-XL 在轨压缩                             | [R5, R6, R24]   |
...
| 波兰         | Intuition-1                                     |            2023 年 11 月 | 高光谱遥感卫星                  | KP Labs Leopard DPU；AMD Zynq UltraScale+ MPSoC（四核 Cortex-A53、双核锁步 Cortex-R5）与 FPGA | 厂商披露的 3 TOPS（非统一精度下的在轨实测吞吐）               | 产品规格：16 GiB DDR4 ECC；4 GiB SLC NAND（EDAC）；2×240 GiB pSLC 冗余存储；5–20 W（负载相关）             | 192 波段高光谱数据处理、云筛选、目标/场景分析                                             | [R9]            |
| 美国 / 国际空间站 | HyTI                                            | 2024-04-18（从 ISS 部署入轨） | 热红外高光谱遥感载荷               | Unibap iX5 系列异构星载计算机                                                               | 未公开                                       | 未公开                                                                                    | 面向热红外高光谱数据处理、L1/L2 产品生成与农业用水监测的星上处理设计                                 | [R10, R14]      |
| 美国         | LizzieSat-3 / FeatherEdge Gen-2                 |             2025-03-14 | 商业遥感/边缘 AI 卫星            | FeatherEdge Gen-2，采用 NVIDIA Jetson Orin NX                                         | 约 100 TOPS                                | 16 GB 128-bit LPDDR5；680 GB pSLC NVMe SSD（ECC）；9.3 W 空闲、20 W 典型、30 W 峰值（均为 Gen-2 模组规格） | 多传感器数据融合、事件检测和边缘 AI；FeatherEdge Gen-2 已在轨运行                           | [R11, R12]      |
| 美国 / 国际空间站 | HPE Spaceborne Computer 系列                      |             2017 年起多批次 | ISS 机柜级参考平台，不属于独立卫星载荷    | HPE Apollo、Edgeline EL4000、ProLiant 等服务器节点；GPU 配置随批次变化                             | 不同批次配置不同，整体为 teraflop 级及以上服务器级计算能力        | 服务器级内存与存储，具体批次配置不同；依托 ISS 供电、散热与机架环境                                                   | HPC、科学数据分析、医疗计算及 AI 工作流                                               | [R13]           |
| 美国         | Starcloud-1                                     |             2025-11-02 | 约 60 kg 自由飞行轨道数据中心技术验证卫星 | NVIDIA H100 GPU                                                                    | 未公开（不以地面 H100 数据表替代在轨能力）                  | 未公开；公司公开架构采用太阳能供电与被动辐射散热，但未披露 Starcloud-1 的具体配置                                        | nanoGPT 在轨训练                                                          | [R15, R25, R26] |
| 美国         | Planet Pelican 星座（含 Pelican-4）                  |       2023—2025 年间陆续发射 | 商业高分辨率遥感星座               | NVIDIA Jetson Orin 模组（Pelican-4 已公开确认；其他 Pelican 星的具体配置未完全披露）                      | 未公开                                       | 未公开                                                                                    | Pelican-4 于 2026-03-25 完成在轨飞机目标检测；Pelican 系列使用 Jetson 平台开展星上边缘计算      | [R16, R17, R27] |
...
| 中国         | 创新雷神卫星（Chuangxingleishen / Innovation Raytheon） |             2022-02-27 | 天算星座云原生协同推理实验卫星          | 未公开                                                                                | 未公开                                       | 未公开                                                                                    | 与宝云共同参与星地协同推理验证；轻量模型星上预处理、复杂模型地面推理                                    | [R19]           |
| 中国         | 天算星座北邮一号（BUPT-1）                                |             2023-01-15 | 云原生星上计算主星/开放试验平台         | 多个星上计算组件与容器化服务平台                                                                   | 未公开                                       | 未公开                                                                                    | 已实现容器化载荷部署；开展脑机控星、实时视频传输、星上图像/视频处理与星地协同等试验                            | [R20]           |
| 中国         | 四维高景三号 02                                       |             2025-03-15 | 高分辨率遥感卫星                 | 未公开                                                                                | 星上算力未公开                                   | 未公开                                                                                    | 支持自主快速图像处理、智能目标检测识别与任务规划                                              | [R18]           |
| 中国         | 太空计算星座首批 12 星 / 三体计算星座首批                        |             2025-05-14 | 星座级在轨计算节点                | 未公开                                                                                | 报道称单星最高 744 TOPS、首批总算力约 5 POPS、搭载 8B 参数模型 | 未公开                                                                                    | 实时在轨数据处理、模型推理、星间激光互联与星座协同；公开报道称 100 Gbps 星间光链路和 30 TB 共享存储            | [R22, R23, R28] |

注：表中 TOPS、TFLOPS、GFLOPS 均为不同厂商、不同精度与不同功耗模式下的标称指标，不可直接横向比较，也不等同于实际在轨任务吞吐。
...
- **[R5]** Ortiz del Castillo, M., et al. *Mitigating Challenges of the Space Environment for Onboard Artificial Intelligence: Design Overview of the Imaging Payload on SpIRIT*. CVPR Workshops, 2024; arXiv:2404.08399.
...
- **[R14]** Hawaii Space Flight Laboratory. *Hyperspectral Thermal Imager (HyTI)*.
...
- **[R17]** Planet Labs PBC. *Planet Successfully Runs AI in Space*. Business Wire, 2026-04-07.
  https://www.businesswire.com/news/home/20260407165913/en/Planet-Successfully-Runs-AI-in-Space
...
- **[R18]** 中国航天科技集团有限公司. *我国超大幅宽商业遥感卫星四维高景三号 02 星背后的技术创新*.
  https://www.spacechina.com/n25/n2014789/n2014809/c4289028/content.html
- **[R19]** Wang, S., Zhang, Q., Xing, R., Qi, F., and Xu, M. *The First Verification Test of Space-Ground Collaborative Intelligence via Cloud-Native Satellites*. China Communications, 21(4): 208–217, 2024. DOI: 10.23919/JCC.fa.2022-0422.202404.
  https://ieeexplore.ieee.org/document/10507244/
- **[R20]** Wang, C., Zhang, Y., Li, Q., Zhou, A., and Wang, S. *Satellite Computing: A Case Study of Cloud-Native Satellites*. IEEE International Conference on Edge Computing (EDGE), 2023; arXiv:2307.08530.
...
- **[R28]** 新华网. *具备太空在轨计算能力 我国太空计算卫星星座发射看点解析*. 2025-05-14.
  https://www.news.cn/politics/20250514/3123b1e2612147a4877c0e4d21662691/c.html
