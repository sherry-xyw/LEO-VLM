...
| ---------- | ----------------------------------------------- | --------------------------: | ------------------------ | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------- |
| 欧洲         | Φsat-1 / FSSCat                                 |                  2020-09-03 | 6U CubeSat 遥感技术验证        | HyperScout-2 载荷内集成 Intel Movidius Myriad 2 VPU                                     | 约 1 TOPS（综合峰值口径，精度未公开；不宜标注为 INT8 TOPS）                                                            | 512 MB LPDDR3                                                                          | 星上 CNN 云检测、图像筛选，减少无效影像下传                                              | [R1–R3]         |
...
| 美国 / 国际空间站 | HyTI                                            | 2024-04-18（从 ISS 部署入轨） | 热红外高光谱遥感载荷               | Unibap iX5 系列异构星载计算机（具体飞行 SKU 公开资料不一致，待进一步确认）                        | 未公开；iX5 系列产品含异构 CPU/GPU/VPU 资源，但 HyTI 飞行 SKU 与算力口径待确认                                      | 公开任务资料未完整披露；Unibap iX5 系列产品规格可作候选口径，但不宜直接等同 HyTI 飞行件                           | 面向热红外高光谱数据处理、L1/L2 产品生成与农业用水监测的星上处理设计；任务级 AI 推理性能披露有限                 | [R10, R14]      |
...
| 美国 / 国际空间站 | HPE Spaceborne Computer 系列                      |                  2017 年起多批次 | ISS 机柜级参考平台，不属于独立卫星载荷 | HPE Apollo、Edgeline EL4000、ProLiant 等服务器节点；GPU 配置随批次变化                             | 不同批次配置不同，整体为 teraflop 级及以上服务器级计算能力；不宜以单一 TFLOPS 数值概括                                                | 服务器级内存与存储，具体批次配置不同；依托 ISS 供电、散热与机架环境                                                   | HPC、科学数据分析、医疗计算及 AI 工作流                                               | [R13]           |
...
| 中国         | 创新雷神卫星（Chuangxingleishen / Innovation Raytheon） |                  2022-02-27 | 天算星座云原生协同推理实验卫星          | 公开资料未披露具体计算板卡与操作系统；作为天算星座协同推理试验节点                                      | 未公开                                                                                                 | 未公开                                                                                    | 与宝云共同参与星地协同推理验证；轻量模型星上预处理、复杂模型地面推理                                    | [R19]           |
| 中国         | 天算星座北邮一号（BUPT-1）                                |                  2023-01-15 | 云原生星上计算主星/开放试验平台         | 多个星上计算组件与容器化服务平台                                                                   | 未公开                                                                                                 | 未公开                                                                                    | 已实现容器化载荷部署；开展脑机控星、实时视频传输、星上图像/视频处理与星地协同等试验                            | [R20]           |
| 中国         | 四维高景三号 02                                       |                  2025-03-15 | 高分辨率遥感卫星                 | 未公开                                                                                | 星上算力未公开；公开资料确认具备自主快速图像处理与智能目标检测识别能力                                                | 未公开                                                                                    | 公开资料称支持自主快速图像处理、智能目标检测识别与任务规划；计算单元、精度口径等待公开                         | [R18]           |
| 中国         | 太空计算星座首批 12 星 / 三体计算星座首批                        |                  2025-05-14 | 星座级在轨计算节点                | 星载智能计算节点；芯片、板卡、内存和功耗清单未公开                                                          | 官方公开信息确认首批 12 星入轨及远期 1,000 POPS 目标；新华社等公开报道称单星最高 744 TOPS、首批总算力约 5 POPS、搭载 8B 参数模型，相关硬件构成与测试口径尚未完整披露 | 未公开                                                                                    | 实时在轨数据处理、模型推理、星间激光互联与星座协同；公开报道还称 100 Gbps 星间光链路和 30 TB 共享存储           | [R22, R23, R28] |
...
| 国家/地区 | 任务平台              | 发射日期     | 已能确认的信息                         | 待补证内容                                      |
| ------ | ----------------- | -------- | -------------------------------- | ------------------------------------------ |
| 中国     | 珞珈三号 01（烟台一号） | 2023-01-15 | 已发射并具备遥感视频数据获取能力；现有 Wikipedia 不作为正式参考文献 | 预装目标监测、变化检测、图像压缩及手机端分发能力仍需运营方任务页或技术文献支撑 |
