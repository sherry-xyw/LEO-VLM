...
![五层部署 pipeline](01_Sang_pipeline_p05.png)

![硬件比较表](01_Sang_hardware_p12.png)
...
![GeoFM 压缩与部署流程](02_Du_pipeline_p05.png)

![在轨资源与能耗表](02_Du_resource_p13.png)
...
![分布式边缘 VLM](03_VLMEdge_distributed_p11.png)

![压缩方法分类](03_VLMEdge_compression_p12.png)
...
![Loris 硬件架构](04_SpIRIT_architecture_p03.png)

![空间环境缓解措施](04_SpIRIT_reliability_p06.png)
...
![FPGA 数据流架构](05_FPGASurvey_dataflow_p05.png)

![功耗与能效分析](05_FPGASurvey_power_p22.png)
...
![加速器与容错架构](06_Shao_architecture_p08.png)

![故障容忍与代价](06_Shao_fault_results_p23.png)
...
![MobileVLM 架构](07_MobileVLM_architecture_p05.png)

![移动端与 Orin 时延](07_MobileVLM_latency_p09.png)
...
![AWQ 方法](08_AWQ_method_p03.png)

![边缘设备加速](08_AWQ_edge_speed_p11.png)
...
![可微量化方法](09_QViT_method_p05.png)

![ImageNet 结果](09_QViT_results_p06.png)
...
![跨模态蒸馏](10_TinyCLIP_distillation_p03.png)

![压缩与精度结果](10_TinyCLIP_results_p06.png)
...
![RemoteTrimmer 方法](11_RemoteTrimmer_method_p02.png)

![剪枝结果](11_RemoteTrimmer_results_p03.png)
...
![高分辨率处理框架](12_LLaVAUHD_framework_p05.png)

![精度与计算量](12_LLaVAUHD_results_p08.png)
...
![KIVI 非对称量化](13_KIVI_method_p05.png)

![吞吐结果](13_KIVI_throughput_p08.png)
...
![分页式 KV 管理](14_vLLM_system_p05.png)

![服务吞吐结果](14_vLLM_throughput_p10.png)
...
![三类稀疏注意力模式](15_MInference_patterns_p04.png)

![长上下文结果](15_MInference_results_p07.png)
...
![训练与自推测解码](16_LayerSkip_overview_p02.png)

![任务加速结果](16_LayerSkip_speedup_p16.png)
